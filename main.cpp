...
int main (){
	...
	do{
		...
		else if (_stricmp (pch, "CREATEFILE") == 0){
			pch = strtok (NULL, "( ,)\n");
			if (pch != NULL){
		...
		else if (_stricmp (pch, "REPLACE") == 0){
			pch = strtok (NULL, "( ,)\n");
			if (pch != NULL){
				pch1 = strtok (NULL, "( ,)\n");
				if (pch1 != NULL){
